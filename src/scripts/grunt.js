...
class GruntRunner {
    ...
    createTemplate() {
        ...
        template = template
            ...
            .replace(/{{env\.BASEPATH_BOOTSTRAP4_BUNDLE}}/g, this.project_dir)
            .replace(/{{env\.NODE_MODULES_BOOTSTRAP4}}/g, path.join(this.project_dir, 'node_modules'));
...
try {
    ...
    const task = process.argv[2] || 'bootstrap4:dist';
