...
```bash
npm install @vigihdev/bootstrap4-bundle
```
...
```javascript
// Import the bundle
import "@vigihdev/bootstrap4-bundle/dist/css/bootstrap-bundle.css";
import "@vigihdev/bootstrap4-bundle/dist/js/bootstrap-bundle.js";
